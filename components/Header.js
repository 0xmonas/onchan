...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-6">
        <div className="flex items-center justify-start w-[120px] md:w-[240px]">
          <Link href="/" className="flex items-center">
            <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 29.5" className="h-8 w-auto md:h-10">
  ...
  <button
    ...
    className="p-2 md:p-3 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
    aria-label={isDarkMode ? "Switch dark" : "Switch day"}
  >
    {isDarkMode ? (
  ...
  {isConnected && currentUser && (
    ...
    >
      <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
